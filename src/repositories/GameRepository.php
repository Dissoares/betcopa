...
class GameRepository
{
    ...
    /** Exclui um jogo (e apostas vinculadas são verificadas no service). */
    ...
    /** Conta apostas vinculadas a um jogo. */
    public function countBets(int $id): int
    {
        $stmt = $this->db->prepare('SELECT COUNT(*) FROM apostas WHERE jogo_id = :id');
        $stmt->execute(['id' => $id]);
